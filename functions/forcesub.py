    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned. Contact My [Support Channel](https://t.me/ExtraBotsUpdtes).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            chat_id=message.from_user.id,
            text="Something Went Wrong. Contact My [Support Channel](https://t.me/ExtraBotsUpdtes).",
            parse_mode="markdown",
            disable_web_page_preview=True,
            reply_to_message_id=message.message_id,
        )
