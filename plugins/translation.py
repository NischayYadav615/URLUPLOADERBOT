...
"""
    ABOUT_TEXT = """
**📛 My Name** : [Uploader Bot Beta 🔥🚀](http://t.me/Url_Uploader_X_robot)

**❤️ Version** : [Beta 🔥](http://t.me/Url_Uploader_X_robot)

**🧿 Language** : [Python 3.10.9](https://www.python.org/)

**📢 Framework** : [Pyrogram 1.4.16](https://docs.pyrogram.org/)

**👨‍💻 Developer** : [LISA](https://t.me/NischayBots)

🚴 Maintained By : [ExtraBots](https://t.me/ExtraBotsUpdates)
